...
public class BluestoneSec14 {
	...
	public static void main(String[] args) throws AWTException, InterruptedException, IOException {
      WebDriver driver= new ChromeDriver();
       ...
       System.out.println("get tittle :"+tittle);
       System.out.println("get class: "+driver.getClass().getName());
       System.out.println("get current url :"+driver.getCurrentUrl());
      WebElement coinimg = driver.findElement(By.xpath("//img[@alt='1 gram 24 KT Lakshmi Gold Coin']"));
