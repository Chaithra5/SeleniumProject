...
public class BluestoneSec29 {
	...
	public static void main(String[] args) throws AWTException, InterruptedException, IOException {
     ...
     WebElement money = driver.findElement(By.xpath("//span[text()=' 1,000']"));
     System.out.println(money.getText());
     if((money.getText()).equalsIgnoreCase("Rs 1000"))
     {
    	 System.out.println("money is displayed correctly");
     }
     WebElement email = driver.findElement(By.xpath("//div[@class='col-xs-12 fl-wrap with-icon auto-filled success']"));
